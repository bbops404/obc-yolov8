...
sys.path.append('/Users/user/Documents/obc-yolov8/ultralytics10.24/ultralytics/nn')
...
def main():
    ...
    data_yaml = f"/Users/user/Documents/obc-yolov8/ultralytics10.24/dataset_root/combined_all/fold{fold}.yaml"
